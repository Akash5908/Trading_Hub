...
export const HomePage = () => {
  ...
  return (
    <main className="flex min-h-screen flex-col bg-background selection:bg-primary/30 selection:text-primary">
        ...
        <div className="mx-auto w-full max-w-7xl relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-12">
            <div className="max-w-4xl space-y-10">
              <motion.div
                className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-4 py-1.5 text-sm font-bold text-primary backdrop-blur-md"
              ...
              <motion.h1
                className="text-balance text-7xl font-semibold leading-[0.95] tracking-tighter text-white md:text-[140px]"
                initial={{ opacity: 0, y: 40 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            <motion.div
              className="max-w-md space-y-8 md:pb-6 w-full "
              initial={{ opacity: 0, y: 40 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, ease: "easeOut" }}
            >
              <div className="max-sm:h-50">
                <LoopText
                  className="text-2xl leading-relaxed text-muted-foreground font-medium"
                  value="Your portal to stop guessing and start innovating. Securely
      ...
      <motion.section className="px-6 py-32 md:py-56 relative overflow-hidden">
        ...
        <motion.div
          ...
          initial={{ opacity: 0, y: 40 }}
          animate={
            isSeamlessInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 40 }
          }
          whileInView={{ opacity: 1 }}
